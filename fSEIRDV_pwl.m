function [T_tot,S_tot,E_tot,I_tot,R_tot,D_tot,V_tot,BETA,PAR_tot,err_rel,OUT]=fSEIRDV_pwl(PAR0,beta0,E0,I,R,D,V,N,...
    ind_inizio,ind_fine,Tintervals,Method)
if nargin==11
...
while cond_true
    ...
    end %options=optimoptions(options,'FiniteDifferenceType','central','FiniteDifferenceStepSize',1.e-5)
