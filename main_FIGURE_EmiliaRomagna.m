Acquisizione_dati_EmiliaRomagna;
...
%%
figure
plot(date_all(T_tot),R(T_tot),'.-','MarkerSize',18,'Color',[0.96,0.58,0.02],'LineWidth',1.5); hold on;
plot(date_all(T_tot),Lin_R,'--g','LineWidth',1.5); hold on
plot(date_all(T_tot),Exp_R,'-.k','LineWidth',1.5); hold on
y_labels = get(gca, 'YTick'); y_labels = y_labels(2:3:end);
set(gca,'FontSize',17,'fontweight','bold','YTick', y_labels,'YTicklabels',y_labels,'Xtick',labelsx); grid on; xtickangle(0);
...
set(gca,'FontSize',17,'fontweight','bold','YTick', y_labels,'YTicklabels',y_labels,'Xtick',labelsx); grid on; xtickangle(0);
%title('D');legend('Data','Model'); axis tight
%%
figure
plot(date_all(T_tot),V(T_tot),'.','Color',[0.30,0.75,0.93],'MarkerSize',18,'LineWidth',0.8); hold on;
plot(date_all(T_tot),Lin_V,'--g','LineWidth',2.5); hold on
plot(date_all(T_tot),Exp_V,'-.k','LineWidth',1.5); hold on
y_labels = get(gca, 'YTick'); y_labels = y_labels(2:3:end);
set(gca,'FontSize',17,'fontweight','bold','YTick', y_labels,'YTicklabels',y_labels,'Xtick',labelsx); grid on; xtickangle(0);
...
Ris_Prev_EmiliaRomagna;
ind_inizio=55;
labelsx(1)=date_all(ind_inizio);
labelsx(3)=date_all(tk-10);
...
%legend('calibration data', 'acquired data','linear model',['prevision T\_tot(end)-',num2str(prove_pwl(1))],...
%    ['prevision T\_tot(end)-',num2str(prove_pwl(2))],'Location','best');
y_labels = get(gca, 'YTick'); y_labels = y_labels(2:3:end);
...
%legend('calibration data', 'acquired data','exp model',['prevision T\_tot(end)-',num2str(prove_pwl(1))],...
%    ['prevision T\_tot(end)-',num2str(prove_pwl(2))],'Location','best');
y_labels = get(gca, 'YTick'); y_labels = y_labels(2:3:end);
set(gca,'FontSize',17,'fontweight','bold','YTick', y_labels,'YTicklabels',y_labels,'XTick',labelsx); grid on; xtickformat('yyyy/MM/dd');
